  ...
  <article id="user-center">
      <aside>
        <section class="head-img">
          <img src="@/static/img/default_head_img.png" alt="" v-if="!userData.head_img">
        ...
        <section class="menu">
          <ul>
            <nuxt-link to="/user/center" tag="li" active-class="active">账号中心</nuxt-link>
            <nuxt-link to="/user/article/manage" tag="li" active-class="active">文章管理</nuxt-link>
          </ul>
        </section>
      </aside>
      <keep-alive>
...
export default {
  ...
  //   next(vm => {
  //     if ( !vm.$store.state.userData.name ) {
